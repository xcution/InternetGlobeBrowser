Public Class FRM_MENSAGENS_AO_USUARIO


    'Variáveis temporarias

    Public v_mensagem_FRM_MENSAGENS_AO_USUARIO As String = Nothing 'Mensagem a ser exibida

    Public v_tipo_de_mensagem_repassada As Byte 'Informa o tipo de mensagem repassada
    ...
    'Procedimentos basicos criados

    Private Sub proc_exibir_mensagem() 'Exibe a mensagem
        On Error Resume Next

        LabelX1.Text = v_mensagem_FRM_MENSAGENS_AO_USUARIO 'Mensagem a ser exibida
    ...
    Private Sub proc_informe_com_voz_texto_da_janela() 'Informa com voz o texto da janela em exibição.
        ...
        V_TEXTO_DA_JANELA = v_mensagem_FRM_MENSAGENS_AO_USUARIO 'Atualizando...
    ...
    Private Sub proc_aplicar_imagem_correta_da_mensagem() 'Aplica imagem correta da mensagem
        On Error Resume Next


        'Selecionando o tipo de imagem de mensagem ------------------------------------------------------------------

        Select Case v_tipo_de_mensagem_repassada


            Case v_tipo_ms_1

                ReflectionImage1.Image = LST_IMAGENS.Images.Item(0) 'Informação


            Case v_tipo_ms_2

                ReflectionImage1.Image = LST_IMAGENS.Images.Item(1) 'Alerta


            Case v_tipo_ms_3

                ReflectionImage1.Image = LST_IMAGENS.Images.Item(2) 'Erro
    ...
    Private Sub FRM_MENSAGENS_AO_USUARIO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error Resume Next
        ...
        proc_exibir_mensagem() 'Exibe a mensagem

        proc_informe_com_voz_texto_da_janela() 'Informa com voz o texto da janela em exibição.

        proc_aplicar_imagem_correta_da_mensagem() 'Aplica imagem correta da mensagem
    ...
    Private Sub FRM_MENSAGENS_AO_USUARIO_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        On Error Resume Next
